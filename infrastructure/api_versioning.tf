...
locals {
  v1_routes = [
    ...
    { name = "v1_cart_get",         route_key = "GET /v1/cart",                       integration = "user",     protected = true },
    { name = "v1_cart_add",         route_key = "POST /v1/cart/add",                  integration = "user",     protected = true },
    { name = "v1_cart_remove",      route_key = "DELETE /v1/cart/remove/{id}",        integration = "user",     protected = true },
    { name = "v1_cart_clear",       route_key = "DELETE /v1/cart",                    integration = "user",     protected = true },
    { name = "v1_wishlist_get",     route_key = "GET /v1/wishlist",                   integration = "user",     protected = true },
    { name = "v1_wishlist_add",     route_key = "POST /v1/wishlist/add",              integration = "user",     protected = true },
    { name = "v1_wishlist_remove",  route_key = "DELETE /v1/wishlist/remove/{id}",    integration = "user",     protected = true },
    { name = "v1_addresses_get",    route_key = "GET /v1/addresses",                  integration = "user",     protected = true },
    { name = "v1_addresses_post",   route_key = "POST /v1/addresses",                 integration = "user",     protected = true },
    { name = "v1_addresses_put",    route_key = "PUT /v1/addresses/{id}",             integration = "user",     protected = true },
    { name = "v1_addresses_del",    route_key = "DELETE /v1/addresses/{id}",          integration = "user",     protected = true },
    { name = "v1_profile_get",      route_key = "GET /v1/profile/me",                 integration = "user",     protected = true },
    { name = "v1_profile_put",      route_key = "PUT /v1/profile/me",                 integration = "user",     protected = true },
    { name = "v1_profile_verify",   route_key = "POST /v1/profile/verify-email",      integration = "user",     protected = true },
