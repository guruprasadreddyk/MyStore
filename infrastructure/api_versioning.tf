...
locals {
  v1_routes = [
    { name = "v1_products",         route_key = "GET /v1/products",             integration = "product", protected = false },
    { name = "v1_product_by_id",    route_key = "GET /v1/products/{id}",       integration = "product", protected = false },
    { name = "v1_search",           route_key = "GET /v1/search",              integration = "search", protected = false },
